...
import { ApiRequestOptions } from "../../utils/axios";
import { apiRequest } from "../../utils/axios";
import { getreqHeaders } from "../../utils/utility";
...
export abstract class Controller {
    ...
    async apiRequest(data: ApiRequestOptions) {
        return apiRequest<any>(data);
    }

    async getHeaders(req: Request) {
        return getreqHeaders(req);
    }
}
